  ...
  return (
    <html lang="en">
      ...
      <body className={inter.className} style={{ backgroundColor: "#001222" }} suppressHydrationWarning>
        ...
        />
        <script dangerouslySetInnerHTML={{ __html: `(function(){function k(){var c=document.getElementById("__splash_cover");if(c)c.remove();document.body.style.backgroundColor="";var h=document.getElementById("__hide_nav");if(h)h.remove()}if(window.location.pathname!=="/"){k();return}var n=document.createElement("style");n.id="__hide_nav";n.textContent="nav{opacity:0!important}";document.head.appendChild(n);window.addEventListener("load",function(){setTimeout(k,2500)});setTimeout(k,4000)})();` }} />
        <Navbar />
